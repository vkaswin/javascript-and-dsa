...
console.log(lfu.put(1, 1)); // cache=[1,_], cnt(1)=1
console.log(lfu.put(2, 2)); // cache=[2,1], cnt(2)=1, cnt(1)=1
console.log(lfu.get(1)); // return 1
// cache=[1,2], cnt(2)=1, cnt(1)=2
console.log(lfu.put(3, 3)); // 2 is the LFU key because cnt(2)=1 is the smallest, invalidate 2.
// cache=[3,1], cnt(3)=1, cnt(1)=2
